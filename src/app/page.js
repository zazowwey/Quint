...
export default async function Home() {
  ...
  return (
    <main>
      ...
      <div className="w-[100%] h-[900vh] relative ">

        {/* Hero section */}

        <section className="w-full h-[110vh] pb-[21px] sticky top-0 left-auto right-auto bottom-auto z-[1]">
        ...
        <div className="flex flex-col items-start justify-start w-[100%] h-[100vh] overflow-hidden sticky top-0 left-auto right-auto bottom-auto z-[2]">
          <div className="flex flex-col items-start juftify-start gap-0 w-[100%] h-[100%] overflow-hidden">
            <div className="grid grid-cols-2 grid-rows-1 items-stretch justify-stretch gap-0 h-[100%] overflow-visible w-[200vw]">

              {/* About section */}

              <section className="w-[100vw] px-(--main-padding) lg:h-[100vh] md:h-auto h-auto pb-[21px] pt-[50px] bg-(--C100)">
              ...
              {/* Project section */}
              <section className="w-[100vw] h-[100%] bg-(--C100)">
                <div className="w-[100%] h-[100%] mx-auto">
                  <div className="flex flex-col items-center justify-stetch h-[100%] relative w-[100%]">
                    ...
                    <div className="w-[100vw] h-[100%] flex flex-col items-end justify-start absolute top-0 left-0 right-0 bottom-0">
                      <div className="flex flex-row items-start justify-end w-[100%] h-[100%] overflow-hidden">
                        <div className="flex flex-col items-end justify-end w-[100vw] h-[100%] relative">
                          {project?.map((item) => (
                            <div className="w-[3%] h-[100%] overflow-hidden absolute top-0 bottom-0 flex flex-row items-start justify-start" style={{ zIndex: item.order_index }} key={item.id}>
