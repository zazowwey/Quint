    ...
    return (
        <div className="w-[100vw] lg:h-[100vh] h-auto flex flex-row items-start justify-end lg:overflow-hidden overflow-visible">
            <div className="w-full h-[100%] flex lg:flex-row md:flex-col flex-col items-stretch justify-end">
                ...
                <div className="flex flex-col items-center justify-stretch lg:gap-[60px] md:gap-[60px] gap-[40px] lg:pt-[120px] md:pt-[80px] pt-[70px] lg:pr-[63px] md:pr-(--main-padding) pr-(--main-padding) lg:pl-[69px] md:pl-(--main-padding) pl-(--main-padding) pb-[80px] w-[100%] lg:h-[100%] h-auto bg-(--C100)">
                    ...
                    <div className="flex lg:flex-row md:flex-col flex-col items-end lg:justify-stretch md:justify-stretch justify-stretch gap-[64px] w-[100%] relative">
                        ...
                        <div className="flex flex-row items-end lg:justify-start md:justify-start justify-center lg:w-[958px] md:w-full w-full lg:h-[416px] h-auto relative">
