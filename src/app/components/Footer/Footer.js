                            ...
                            <div className="flex flex-col items-stretch justify-start gap-[16px] lg:w-auto md:w-auto w-[100%]">
                                ...
                                <form className="w-full" onSubmit={handleSubmit}>
                                    <div className="flex flex-row items-stretch justify-start w-[100%]">
                                        ...
                                        <input className="border-y-[1px] border-(--C200) border-r-[1px] lgw-[263px] md:w-[263px] w-[100%] h-[40px] px-[12px] py-[8px] outline-none placeholder-(--C200) font-Secondary text-(--C200)" type="text" placeholder="Last Name" name="lastName" onChange={handleChange}></input>
                                    </div>
                                    <div className="flex flex-row items-stretch justify-start w-[100%]">
                                        <input className="border-b-[1px] border-(--C200) border-r-[1px]  h-[40px] px-[12px] py-[8px] outline-none placeholder-(--C200) font-Secondary text-(--C200) lg:w-[486px] md:w-[486px] w-[100%]" type="email" placeholder="E-mail" name="to" onChange={handleChange}></input>
                                        <button className="bg-(--C300) px-[12.5] py-[14.5] w-[40px] h-[40px] flex flex-row items-center justify-center cursor-pointer" type="submit">
