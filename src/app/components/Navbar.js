...
export default function Navbar(){
    return(
        <nav className = "w-full h-auto bg-transparent fixed z-999 top-0 bottom-auto right-0 left-0 backdrop-blur-md bg-blend-difference" >
                    ...
                    <div className = "w-full h-full flex flex-row items-center justify-between py-[20px] px-(--main-padding) border-b border-solid border-(--C500)">
                        ...
                        {/* Nav left col */}
                         <div className = "w-[50%] h-[40px] flex flex-row items-center justify-start gap-[83px]">
                            ...
                            {/* Brand */}
                            <div className = "w-[105px] h-auto p-[4px] overflow-hidden relative z-3 bg-(--C100) rounded-full flex items-center justify-start">
                        ...
                        {/* Nav right col */}
                         ...
                         <div className = "w-[50%] h-[40px] flex flex-row items-center justify-end gap-[83px]">
                            ...
                            <div className = "w-auto h-auto px-[20px] py-[11px] overflow-hidden relative z-3 bg-(--C100) rounded-full flex items-center justify-end gap-[10px]">
